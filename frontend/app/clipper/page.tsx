  ...
  return (
    <div className="min-h-screen bg-background p-8 font-sans">
      <header className="mb-12 flex justify-between items-center max-w-5xl mx-auto">
        <h1 onClick={() => window.location.href = "/"} className="text-4xl font-serif font-medium tracking-tight">Kern. <span className="text-muted-foreground text-2xl">/ Clipper</span></h1>
